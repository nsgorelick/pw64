...
quantize(char *data, int ncolors, int height, int width, struct quant_data **quant, int base)
{
    int i,j;
    int n_pixels;
    int count;
    ...
    table = (struct quant_entry *)malloc((unsigned int)ncolors*
            sizeof(struct quant_entry));
