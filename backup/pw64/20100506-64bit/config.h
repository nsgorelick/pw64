...
/* define the following if libXpm is available */
/* #undef HAVE_LIBXPM */

/* define the following to disable "core"-file generation */
#define CORE 1

/* define the following to use the built-in specpr reader */
#define INTERNAL_SP 1
...
/* Define if you have the <magick/magick.h> header file.  */
...
/* Define if you have the getnetname library (-lgetnetname).  */
/* #undef HAVE_LIBGETNETNAME */
