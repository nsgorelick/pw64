...
CButton
XfCreateCB(Display *d, Window win, int x, int y, int w, int h, int hi, int lo, int fg, int bg, char *text, int align, XFontStruct *font, CallBack func)
{
	CButton new;
...
Pixmap
XfSetCBPixmap(CButton CB, Pixmap pixmap, int w, int h)
{
