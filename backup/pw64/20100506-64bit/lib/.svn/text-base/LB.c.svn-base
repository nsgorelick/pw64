...
LButton
XfCreateLB(Display *d, Window win, int x, int y, int w, int h, int hi, int lo, int fg, int bg, char *text, int align, XFontStruct *font)
{
	LButton new;
...
Pixmap
XfSetLBPixmap(LButton LB, Pixmap pixmap, int w, int h)
{
