 ...
 *
 * $Log$
 * Revision 1.2  2005/03/05 02:05:12  gorelick
 * Fixing vararg->stdarg and also -lz not being found
 *
...
struct VisualInfo *XfCreateVisual(void *,
	int	, int , int	, int , unsigned long , unsigned long , int	, ...);
