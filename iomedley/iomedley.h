...
int iom_GetJPEGHeader(FILE *fp, char *fname, struct iom_iheader *h);
int iom_GetPNGHeader(FILE *fp, char *fname, struct iom_iheader *h);
int iom_GetTIFFHeader(FILE *fp, char *fname, struct iom_iheader *h);
int iom_GetGIFHeader(FILE *fp, char *fname, struct iom_iheader *h);
