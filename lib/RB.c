...
RButton
XfCreateRB(Display *d, Window win, int x, int y, int w, int h, short int hi, short int lo, short int fg, short int bg, char *text, int align, XFontStruct *font, CallBack func, RButton RBlist)
{
	RButton new;
	RButton search;
...
void
XfActivateRBList(RButton RB, int count)
{
