...
Button XfCreateButton(Display *, Window, int, int, int, int, int, long unsigned int, char *, int);
Button XFCreateButton(Display *, Window, int, int, int, int, int, long unsigned int, long unsigned int, char *, int);
