...
MenuItem *
XfAddMenuItem(MenuItem *parent, char *str, int align, XFontStruct *font, Pixmap pixmap, int p_width, int p_height, void *id)
{
    MenuItem *new;
...
MenuItem *
StringToMenu(char *string, MenuItem *parent, int idval)
{
    int level;
    char *p;
    char *q;
...
void
print_menu(MenuItem *parent, int level)
{
    int i;
...
MButton
XfCreateMB(Display *d, Window win, int x, int y, int w, int h, int hi, int lo, int fg, int bg, MenuItem *menu, CallBack func)
{
    MButton new;
...
int
HitTest(MButton MB, MenuItem *menu, int x, int y)
{
	int i;
	int last;
	int height;
...
void
draw_MenuItem(MButton MB, MenuItem *menu, int xoff, int yoff, int height, int r, int invert)
{
...
void
draw_separator(MButton MB, MenuItem *menu, int xoff, int yoff, int r)
{
    Display *display = MB->display;
    Window window = MB->window;
    GC gc = DefaultGC(display, DefaultScreen(display));
...
void
SetMenuText(MButton MB, MenuItem *new, char *str)
{
