...
#define RingThatBell(znumz)                                                                                            \
    {                                                                                                                  \
        int ziz;                                                                                                       \
        for (ziz = 0; ziz < znumz; ++ziz)                                                                              \
            printf("%c", (char)7);                                                                                     \
    }
...
#define SayGoodbye()                                                                                                   \
    {                                                                                                                  \
        printf("I'm out of memory and I can't get up!\n");                                                             \
        exit(1);                                                                                                       \
    }
...
#define CopyString(zstrz, zoldz)                                                                                       \
    {                                                                                                                  \
        if (zoldz == NULL)                                                                                             \
            ...
            NewString(zstrz, (1 + strlen(zoldz))) strcpy(zstrz, zoldz);                                                \
        }                                                                                                              \
    }
...
#define AppendString(zstrz, znewz)                                                                                     \
    {                                                                                                                  \
        if (znewz != NULL) {                                                                                           \
            if (zstrz == NULL)                                                                                         \
                NewString(zstrz, 1 + strlen(znewz)) else zstrz =                                                       \
                    (char *)realloc(zstrz, 1 + strlen(znewz) + strlen(zstrz));                                         \
            if (zstrz == NULL)                                                                                         \
                SayGoodbye() else strcat(zstrz, znewz);                                                                \
        }                                                                                                              \
    }
...
#define NewStringList(zstrz, zlistz)                                                                                   \
    {                                                                                                                  \
        if (zlistz != NULL)                                                                                            \
            RemoveStringList(zlistz) zlistz = (TB_STRING_LIST *)malloc(sizeof(TB_STRING_LIST));                        \
        zlistz->next = NULL;                                                                                           \
        if (zlistz == NULL)                                                                                            \
            SayGoodbye() if (zstrz == NULL) NewString(zlistz->text, 1) else CopyString(zlistz->text, zstrz)            \
    }
...
#define AddStringToList(zstrz, zlistz)                                                                                 \
    {                                                                                                                  \
        TB_STRING_LIST *znz = NULL, *znnz = NULL;                                                                      \
        if (zlistz == NULL)                                                                                            \
            NewStringList(zstrz, zlistz) else                                                                          \
            {                                                                                                          \
                for (znz = zlistz; znz->next != NULL; znz = znz->next)                                                 \
                    ;                                                                                                  \
                NewStringList(zstrz, znnz) znz->next = znnz;                                                           \
            }                                                                                                          \
    }
